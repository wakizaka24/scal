...
const FontWeight calendarDayFontWeight = FontWeight.w600;
const double calendarEventFontSize = 10;
const FontWeight calendarEventFontWeight = FontWeight.w600;
const double eventListTitleFontSize = 13;
const FontWeight eventListTitleFontWeight = FontWeight.w400;
const double eventListItemFontSize = 13;
const FontWeight eventListItemFontWeight = FontWeight.w400;
